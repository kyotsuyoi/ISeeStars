...
public class ProgressBarAnimated : ProgressBar
{
    ...
    {
        _targetValue = max;
        _animationPart = new Rectangle(foreground.Width, 0, 0, foreground.Height);
    ...
    public override void Update(float value)
    {
        ...
        {
            currentValue -= _animationSpeed * Globals.ElapsedSeconds;
    ...
    {
        base.Draw();
        Globals.SpriteBatch.Draw(foreground, _animationPosition, _animationPart, _animationShade, 0f, Vector2.Zero, 1f, SpriteEffects.None, 1f);
    }
}
